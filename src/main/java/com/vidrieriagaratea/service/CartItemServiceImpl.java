...
import com.vidrieriagaratea.exception.CartItemException;
import com.vidrieriagaratea.exception.UserException;
import com.vidrieriagaratea.model.Cart;
import com.vidrieriagaratea.model.CartItem;
import com.vidrieriagaratea.model.Product;
import com.vidrieriagaratea.model.User;
import com.vidrieriagaratea.repository.CartItemRepository;
import com.vidrieriagaratea.repository.CartRepository;
...
public class CartItemServiceImpl implements CartItemService{
	...
	public void removeCartItem(Long userId, Long cartItemId) throws CartItemException, UserException {
		...
		if(user.getId().equals(reqUser.getId())) {
			...
			throw new UserException("you cant't remove another users item");
		}
	}
